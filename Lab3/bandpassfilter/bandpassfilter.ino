...
int lpFilteredSample = 127;   // lågpass-output (nedre)
int lpFilteredSample2 = 127;  // lågpass-output (övre)
int bpFilteredSample = 127;   // bandpass-output
...
void loop()
{
  ...
  // --- Beräkna andra alpha för bandpass ---
  ...
  // --- Bandpass: högre LP minus lägre LP med DC-offset korrigering ---
  ...
  // --- Skicka till PWM ---
  OCR2A = (uint8_t)bpFilteredSample;
}
